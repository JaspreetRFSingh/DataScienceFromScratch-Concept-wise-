...
mylist = ['s','d','k','b','c','b','d','k','j','j','s','d','f','g','d','d','k','k','g','d','a','k','s','d','h','a','s','l','d','a','s','l','d','h','i','a','s','g','d','u','v','s','n','s','d','h','f','k','d','s','f','z','z','s','j','x','a','s','x','k','a','s','n','x','l','a','c']

#occs = Counter(mylist)
#print(occs.most_common(2)[0])

print("Return value: " + majority_vote(mylist))
